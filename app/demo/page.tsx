...
const mockObjects: ClassifiedObject[] = [
  ...
  },
  {
    object: {
      ...
      type: '0x2::sui::SUI',
      digest: '0xfedcba0987654321fedcba0987654321fedcba09',
  ...
  },
  {
    object: {
      ...
      objectType: ObjectType.NFT,
      type: 'NFT',
      digest: '0x9876543210fedcba9876543210fedcba98765432',
      packageId: '0x9876543210fedcba9876543210fedcba98765432',
      moduleName: 'unknown_nft',
      name: 'Unknown NFT #42',
  ...
  },
  {
    object: {
      ...
      owner: '0xabcdef1234567890abcdef1234567890abcdef12',
      objectType: ObjectType.COIN,
      type: '0xscam::coin::SCAM',
      digest: '0xaaaabbbbccccddddeeeeffffaaaabbbbccccdddd',
      coinType: '0xscam::coin::SCAM',
      name: 'SCAM Token',
      symbol: 'SCAM',
  ...
  },
  {
    object: {
      ...
      digest: '0x1111222233334444555566667777888899990000',
      principal: '5000000000',
      stakingPool: '0xvalidator_pool_address',
      name: 'Staked SUI',
  ...
  },
  {
    object: {
      ...
      objectType: ObjectType.NFT,
      type: 'NFT',
      digest: '0xbbbbccccddddeeeeffffbbbbccccddddeeeeaaaa',
      packageId: '0xbbbbccccddddeeeeffffbbbbccccddddeeeeaaaa',
      moduleName: 'cool_cats',
      name: 'Cool Cat #999',
  ...
  },
  {
    object: {
      ...
      type: '0xgame::items::Sword',
      digest: '0xccccddddeeeeffffaaaabbbbccccddddeeee1111',
  ...
  },
  {
    object: {
      ...
      digest: '0xddddeeeeffffaaaabbbbccccddddeeeeffffbbbb',
      itemCount: 5,
      name: 'Personal Kiosk',
...
export default function DemoPage() {
  ...
  const handleRefresh = () => {
    ...
    setTimeout(() => {
      ...
      const randomId = `0x${Math.random().toString(16).substring(2, 42).padEnd(40, '0')}`;
      const newObject: ClassifiedObject = {
        object: isNFT ? {
          ...
          name: `New NFT #${Math.floor(Math.random() * 1000)}`,
          description: 'Newly discovered NFT',
          imageUrl: 'https://via.placeholder.com/150/888888/FFFFFF?text=NEW',
        } : {
          id: randomId,
          owner: '0xabcdef1234567890abcdef1234567890abcdef12',
          objectType: ObjectType.COIN,
          type: '0x2::coin::Coin',
          digest: randomId,
          coinType: '0x2::coin::Coin<0xnew::token::NEW>',
          name: `New Coin #${Math.floor(Math.random() * 1000)}`,
          description: 'Newly discovered coin',
          symbol: 'NEW',
          balance: '1000000',
          decimals: 6,
          iconUrl: 'https://via.placeholder.com/40/888888/FFFFFF?text=NEW',
        } as any,
        classification: [
